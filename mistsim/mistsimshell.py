...
def precomputeclusters(corecalls, outrand, subset, replicates, cores):
    '''creates randomly subsetted genes and gives out a csv file containing cutree of them. Also makes a reference file
    at cutree h= column numbers'''
...
def main():
    ...
    if args.subfunction == 'Random':
        processRandom(args.corecalls, args.outrand, args.subset, args.replicates, args.outfile, args.outplot, args.cores)
