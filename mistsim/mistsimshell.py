...
def arguments():
    ...
    c_parser = subparsers.add_parser('RandomSub')
    c_parser.add_argument('--subset', default='100', help='number of genes to subset randomly')
    c_parser.add_argument('--repeat', default='1000', help='number of times to subset')
