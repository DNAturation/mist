...
def comparesubtoref(outrand, outfile, cores):
...
def arguments():
    ...
    c_parser.add_argument('--corecalls', default='/home/phac/kye/autocreate/prissy/core_calls.csv')
    c_parser.add_argument('--outrand', default='/home/phac/kye/misty/ranclusters')
    c_parser.add_argument('--outfile', default='/home/phac/kye/misty/ranclusters/report.csv')
...
def processRandom(corecalls, outrand, subset, replicates, outfile, cores):
    ...
    comparesubtoref(outrand, outfile, cores)
...
def main():
    ...
    if args.subfunction == 'Random':
        processRandom(args.corecalls, args.outrand, args.subset, args.replicates, args.outfile, args.cores)
